<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nfo.aspx.cs" Inherits="nfo1" %>
    					...
    					<table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
    						<tbody>
    							<tr>
    							 ...
    							 <tr ><td width="32px" height="32" align="center" class="page_title1">N</td>
    							 <td class="page_title2">ew Fund Offers</td></tr>
                                 <tr height="10px"></tr>
    						</tbody>
    					</table>
    				<div class="scroll_nfo">
    				 <table  border="0" cellpadding="0" cellspacing="0" class="text_regular" style="margin-top:0">
       
      <tr height="10px" class="text_regular"><td width="650" class="yellowbar">Latest NFO</td>
        <td width="150" class="yellowbar">
            <asp:Label ID="Label1" runat="server"  Text="Type:"></asp:Label> 
<asp:SqlDataSource ID="DropDownDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>"
    SelectCommand="SELECT DISTINCT type FROM nfo"></asp:SqlDataSource>     
        <asp:DropDownList ID="ddltype" runat="server" AutoPostBack="true" DataSourceID="DropDownDataSource"
    DataTextField="type" DataValueField="Type" AppendDataBoundItems="true">
        <asp:ListItem Text="All" Value=""/>
        
        </asp:DropDownList></td></tr> 
        </table>  
        <asp:GridView ID="nfogridview" 
        runat="server"
    ...
    >
     ...
     <asp:BoundField datafield="open_dt" HeaderText="Open"/>
     <asp:BoundField datafield="close_dt" HeaderText="Close"/>
     </Columns>
        </asp:GridView>
        <asp:SqlDataSource ID="GridDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>"
    SelectCommand="SELECT scheme_name,type,open_dt,close_dt FROM nfo" FilterExpression="type = '{0}'">
    <FilterParameters>
