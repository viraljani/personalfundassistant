...
<body>
	...
	<table width="612" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        ...
        <td width="6" align="center" valign="middle"><img src="img/bullet_1.jpg" width="6" height="6"></td>
        <td width="74" align="center" valign="middle" class="link_grey" style="font-size:14px; font-family:Sans-Serif;">
            <asp:LinkButton runat="server" ID="lnklogout" text="Log out" Font-Size="14px" onclick="logout_Click"/></td></tr>
    </tbody></table>
	</td>
  </tr>
    						</tbody>
  ...
  <tr>
    <td height="5" colspan="2" align="left" valign="top"></td>
    					...
    					<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    						<tbody>
    							<tr>
    							 ...
    							 <tr ><td width="32px" height="32" align="center" class="page_title1">F</td>
    							 <td class="page_title2">und Analysis</td></tr><tr height="20px"></tr>
                               <tr height="10px"></tr>
    						</tbody>
    					</table>
      ...
      <tr height="10px" class="PT5 arial16blue"><td>Check Fund Performance!!<br /></td>
        </tr> <tr style="height:10px"></tr>        
      
        
        <tr>
        <td>Fund House:</td></tr><tr style="height:5px"></tr> 
        <tr><td><asp:DropDownList  ID="ddlFundHouse" runat="server" 
        ...
        </td></tr> <tr style="height:5px"></tr> 
        </tr>
        <tr>
        <td>Scheme Name:</td></tr><tr style="height:10px"></tr> 
        <tr><td><asp:DropDownList ID="ddlSchemeName" align="center" runat="server" AppendDataBoundItems="true" Height="23px" >
        <asp:ListItem Selected="True" Value="0"  Text="----Select Scheme Name----"></asp:ListItem>
        </asp:DropDownList></td></tr><tr style="height:5px"></tr> 
        <tr>
        <td >
        <asp:Button 
        ID="Button1" 
        ...
        class="btnclick"
        width="109px"
        onclick="Buttonsubmit_Click" /></td></tr><tr style="height:10px"></tr> 
        </table> <div style="height:100px">
         <asp:GridView 
        ID="GridView1" 
        runat="server"
     ...
     <asp:BoundField datafield="Fund Type" HeaderText="Fund Type"/>
     <asp:BoundField datafield="Fund Category" HeaderText="Fund Category"/>
     <asp:BoundField datafield="Launch Date" HeaderText="Launch Date" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="false" />
     <asp:BoundField datafield="Return%" HeaderText="Return%"/>
     </Columns>
 
        </asp:GridView><br /><br /><br /><br /></div>
    				</p>
    				</td>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" style="width:1226px">
  <tbody>
  
  <tr class="box_footer link_footer">
    <td width="854" height="50" align="center" valign="middle" > &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="default.asp" class="arial16blue PT5">Home</a> | <a href="aboutus.aspx" class="arial16blue PT5">About Us</a> | <a href="contactus.aspx" class="arial16blue PT5">Contact Us</a> | <a href="privacypolicy.aspx" class="arial16blue PT5">Privacy Policy</a> </td>
  </tr>
